@extends('frontend.header', ['title' => 'Home'])
@section('page-content')
    <!-- ======= Hero Section ======= -->
    <section id="hero" class="d-flex align-items-center">
        <div class="container">
            <h1>Welcome to V-Care</h1>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 d-flex align-items-stretch">
                        <div class="content">
                            <h3>Why Choose V-Care?</h3>
                            <p>
                                At V-CARE Hospital, we understand that choosing a healthcare provider is an important decision. When you choose V-CARE Hospital, you're choosing a healthcare partner you can trust. Experience the V-CARE difference for yourself and discover why we are the preferred choice for individuals and families seeking exceptional medical care in our community.
                            </p>
                            ...
                            <div class="row">
                                <div class="col-xl-4 d-flex align-items-stretch">
                                    <div class="icon-box mt-4 mt-xl-0">
                                        ...
                                        <p>At V-CARE Hospital, we prioritize compassion and empathy in everything we do. Our dedicated team of healthcare professionals is committed to providing personalized care with warmth and understanding.</p>
                                    </div>
                                </div>
                                <div class="col-xl-4 d-flex align-items-stretch">
                                    <div class="icon-box mt-4 mt-xl-0">
                                        ...
                                        <p>Our hospital boasts a team of highly skilled and experienced physicians, surgeons, and specialists who are leaders in their respective fields.</p>
                                    </div>
                                </div>
                                <div class="col-xl-4 d-flex align-items-stretch">
                                    <div class="icon-box mt-4 mt-xl-0">
                                        ...
                                        <p>We believe in putting our patients at the center of everything we do. From the moment you walk through our doors, you'll experience our unwavering dedication to meeting your needs and exceeding your expectations.</p>
                                    </div>
                                </div>
                            </div>
                        </div><!-- End .content-->
